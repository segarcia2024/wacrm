...
const overrides = {
  ...
  "Inbox.sidebar.phone": "Teléfono",
  "Inbox.sidebar.phonePlaceholder": "Agregar teléfono",
  "Inbox.sidebar.copyPhone": "Copiar teléfono",
  "Inbox.sidebar.waIdHint": "Id de WhatsApp: {id}",
  ...
  "Inbox.sidebar.toastInvalidPhone": "Ingresa un teléfono válido con código de país (ej. +573001234567)",
  "Inbox.sidebar.toastPhoneRequired": "El teléfono es obligatorio",
  "Inbox.sidebar.toastPhoneConflict": "Ya existe un cliente con este teléfono",
  ...
  "Contacts.page.exportExcelBtn": "Exportar Excel",
  "Contacts.page.addContactBtn": "Agregar cliente",
  "Contacts.page.tableColumns.name": "Nombre",
  "Contacts.page.tableColumns.phone": "Teléfono",
  "Contacts.page.tableColumns.vehicle": "Vehículo",
  "Contacts.page.tableColumns.email": "Correo electrónico",
  "Contacts.page.tableColumns.company": "Empresa",
  "Contacts.page.tableColumns.tags": "Etiquetas",
  "Contacts.page.tableColumns.createdAt": "Creado",
  "Contacts.page.phoneNotShared": "No compartido",
  "Contacts.page.toastExportFailed": "No se pudo exportar la base de clientes",
  "Contacts.page.toastExportForbidden":
    "Solo los administradores pueden descargar la base de clientes",
  "Contacts.page.toastExportSuccess": "Base de clientes descargada",
