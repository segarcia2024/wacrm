...
// Spec-defined seed — colors/positions per the product spec; names come from i18n.
const DEFAULT_STAGE_SPECS = [
  { key: "newLead" as const, color: "#3b82f6", position: 0 },
  { key: "qualified" as const, color: "#eab308", position: 1 },
  { key: "proposalSent" as const, color: "#f97316", position: 2 },
  { key: "negotiation" as const, color: "#8b5cf6", position: 3 },
  { key: "won" as const, color: "#22c55e", position: 4 },
];
...
export default function PipelinesPage() {
  ...
  const seedDefaultPipeline = useCallback(async (): Promise<Pipeline | null> => {
    ...
    const stagesPayload = DEFAULT_STAGE_SPECS.map((s) => ({
